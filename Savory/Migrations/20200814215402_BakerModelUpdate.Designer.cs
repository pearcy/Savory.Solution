...
namespace Savory.Migrations
{
    ...
    [Migration("20200814215402_BakerModelUpdate")]
    partial class BakerModelUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Savory.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Savory.Models.Baker", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Savory.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Savory.Models.Baker", b =>
                {
                    b.HasOne("Savory.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
